...
import { seamEngine, exaEngine, ddgEngine, bingEngine, jinaSearchEngine, githubEngine, bilibiliEngine, v2exEngine, youtubeEngine, arxivEngine, pubmedEngine, platformEngines, rssEngine, EngineError, } from "./engines.js";
...
export class SearchRouter {
    ...
    pw;
    memory;
    constructor(ctx, config, store, dynamic = () => config, pw, memory = new LruCache(config.memoryCacheEntries)) {
        this.ctx = ctx;
        this.config = config;
        this.store = store;
